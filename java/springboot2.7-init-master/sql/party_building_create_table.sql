...
(
    ...
    totalParticipant  int                                      default 0 not null comment '总报名人数（已报名人数）',
    actualParticipant int                                      default 0 not null comment '实际参与人数（已报名且签到人数）',
...
(
    ...
    participateActivity int                                    default 0 not null comment '报名活动数',
    participateRate     double                                 default 0.0 not null comment '活动参与度(报名且参与活动数/总活动数)',
    signActivity        int                                    default 0 not null comment '签到活动数',
    signRate            double                                 default 0.0 not null comment '签到率(签到活动数/报名活动数)',
...
(
    ...
    totalParticipant    int                                    default 0 not null comment '总报名人数',
    totalSign           int                                    default 0 not null comment '总签到人数',
    avgParticipant      double                                 default 0.0 not null comment '平均每次活动报名人数',

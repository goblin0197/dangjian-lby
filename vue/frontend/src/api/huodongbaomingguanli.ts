...
/** 获取指定活动已报名人员列表 POST /api/activity/enroll/list */
export async function listEnrolledUsersUsingPost(
  body: API.ActivityEnrollListRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseListActivityEnrollUserVO_>(
    "/api/activity/enroll/list",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",

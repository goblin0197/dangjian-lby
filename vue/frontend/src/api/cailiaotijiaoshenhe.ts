...
/** 下载材料文件 GET /api/material/submission/download */
export async function downloadMaterialUsingGet(
    ...
    return request<API.BaseResponseString_>(
        "/api/material/submission/download",
        {
            method: "GET",
            params: {
                ...params,
...
export async function rejectMaterialUsingPut(
    ...
    return request<API.BaseResponseBoolean_>(
        "/api/material/submission/reject",
        {
            method: "PUT",
            params: {
                ...params,
...
/** 提交材料审核 POST /api/material/submission/submit */
export async function submitMaterialUsingPost(
    body: API.MaterialSubmissionSubmitRequest,
    options?: { [key: string]: any },
) {
    return request<API.BaseResponseLong_>("/api/material/submission/submit", {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
...
/** 查看材料详情 GET /api/material/submission/view */

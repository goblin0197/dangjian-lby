...
/** 根据 id 获取用户包装类） GET /api/user/get/vo */
...
/** 获取所有角色 GET /api/user/list/role */
export async function listRoleUsingGet(options?: { [key: string]: any }) {
  return request<API.BaseResponseMapStringString_>("/api/user/list/role", {
    method: "GET",
    ...(options || {}),
  });
}

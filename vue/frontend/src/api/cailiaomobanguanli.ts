...
/** 添加材料模板 POST /api/api/material/template/add */
export async function addMaterialTemplateUsingPost(
  body: API.MaterialTemplateAddRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseLong_>("/api/api/material/template/add", {
    method: "POST",
    headers: {
...
/** 批量切换模板状态 PUT /api/api/material/template/batchToggleStatus */
export async function batchToggleMaterialTemplateStatusUsingPut(
  body: API.MaterialTemplateBatchRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseBoolean_>(
    "/api/api/material/template/batchToggleStatus",
    {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
...
/** 删除材料模板 DELETE /api/api/material/template/delete */
export async function deleteMaterialTemplateUsingDelete(
  body: API.DeleteRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseBoolean_>(
    "/api/api/material/template/delete",
    {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
...
/** 下载模板文件 GET /api/api/material/template/download */
export async function downloadMaterialTemplateUsingGet(
  ...
  return request<API.BaseResponseString_>(
    "/api/api/material/template/download",
    {
      method: "GET",
      params: {
        ...params,
...
/** 获取材料模板列表 GET /api/api/material/template/list */
export async function listMaterialTemplateUsingGet(
  ...
  return request<API.BaseResponseListMaterialTemplateVO_>(
    "/api/api/material/template/list",
    {
      method: "GET",
      params: {
        ...params,
...
/** 预览模板文件 GET /api/api/material/template/preview */
export async function previewMaterialTemplateUsingGet(
  ...
  return request<API.BaseResponseString_>(
    "/api/api/material/template/preview",
    {
      method: "GET",
      params: {
        ...params,
...
/** 切换模板状态 PUT /api/api/material/template/toggleStatus */
export async function toggleMaterialTemplateStatusUsingPut(
  ...
  return request<API.BaseResponseBoolean_>(
    "/api/api/material/template/toggleStatus",
    {
      method: "PUT",
      params: {
        ...params,

...
/** 将终审通过的材料归档 POST /api/material/archive/archive */
export async function archiveMaterialUsingPost(
    // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
    params: API.archiveMaterialUsingPOSTParams,
    options?: { [key: string]: any },
) {
    return request<API.BaseResponseLong_>("/api/material/archive/archive", {
        method: "POST",
        params: {
            ...params,
        },
...
/** 批量导出归档材料为压缩包 POST /api/material/archive/batchExport */
export async function batchExportMaterialArchiveUsingPost(
    ...
    return request<API.BaseResponseString_>(
        "/api/material/archive/batchExport",
        {
            method: "POST",
            headers: {
...
/** 查看归档材料详情 GET /api/material/archive/detail */

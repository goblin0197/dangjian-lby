...
import OrganizationRelationView from "@/views/organization/OrganizationRelationView.vue";
import TrainerRelationManagementView from "@/views/trainerRelation/TrainerRelationManagementView.vue";
...
export const routes: Array<RouteRecordRaw> = [
  ...
  },
  {
    ...
    name: "组织关系",
    component: OrganizationRelationView,
  },
  {
    path: "/trainerRelationManagement",
    name: "培养关系",
    component: TrainerRelationManagementView,
  },
  {
    path: "/activity",
    name: "活动管理",
